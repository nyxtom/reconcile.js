;(function (reconcile) { // wrapper for non-node envs
/**
 * reconcile.js
...
reconcile.diff =  diff;
reconcile.diffString = diffString;
reconcile.diffStyleString = diffStyleString;
reconcile.patch = patch;
reconcile.apply = apply;
reconcile.resolve = resolve;
reconcile.isEqualChange = isEqualChange;
reconcile.isParentChange = isParentChange;
reconcile.sortChange = sortChange;

})(typeof exports === 'undefined' ? this.reconcile = {} : exports);
