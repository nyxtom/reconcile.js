 ...
 * @return {Object}
 */
export function mapElements(nodes) {
    var map = {};
    var tags = {};
    var node;
 ...
 * @return {string}
 */
export function generateId(node, tags) {
 ...
 */
export function diff(source, base, index) {
    var diffActions = [];
...
export function apply(changes, base) {
    ...
    moves.sort(function(a, b) { return sortChangeset(a[3], b[3]); });
